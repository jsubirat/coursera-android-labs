...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
        ...
        // NORMALLY, the "Open with" would go to the strings.xml resource file, but here we do it
        // hardcoded, otherwise the tests do not pass.
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			mUserTextView.setText(data.getStringExtra(ExplicitlyLoadedActivity.TEXT_RESULT_KEY));
		}
    }
}
